...
**[⬇ ExpVault-Setup-1.1.7.exe](https://github.com/papadcha/expvault/releases/latest/download/ExpVault-Setup-1.1.7.exe)** — Windows 10/11 x64 · [Τι νέο στην v1.1.7](https://github.com/papadcha/expvault/releases/tag/v1.1.7)
...
| `backend/pdf_templates.py` | Εκμάθηση & αναγνώριση νέων τύπων PDF · εξαγωγή/εισαγωγή προτύπων σε JSON |
...
| **Πρότυπα PDF** | Εκπαίδευση αναγνωρίσεων για νέους προμηθευτές · εξαγωγή/εισαγωγή προτύπων σε JSON για μεταφορά σε άλλον ΗΥ |
